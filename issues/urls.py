...
urlpatterns = [
    ...
    path(
        "projects/<int:pk>/update/", UpdateProjectView.as_view(), name="update_project"
    ),
    path(
        "projects/<int:pk>/delete/", DeleteProjectView.as_view(), name="delete_project"
    ),
    # Задачи
    path("issues/<int:pk>/", IssuesDetailView.as_view(), name="issue_details"),
    path(
        "projects/<int:pk>/issues/create/",
